...
namespace SF.WebHost
{
	public class CoreDbContextFactory : IDbContextFactory<CoreDbContext>
	{
		...
		public CoreDbContext Create(DbContextFactoryOptions options)
		{
			...
			builder.UseSqlServer("Server=.;Database=SF_Team_2017_Dev;uid=sa;pwd=romaticpeo;Trusted_Connection=True;MultipleActiveResultSets=true;Integrated Security=false;"
